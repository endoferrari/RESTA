...
## 2. Configurar el papel y el corte

En **Impresoras y escáneres → XP-Q200II → Preferencias de impresión**:

- Tamaño de papel: **80(72) x Receipt** (rollo de 80 mm, área imprimible 72 mm).
...
| Sale una hoja «tamaño carta» en blanco | La predeterminada no es la XP-Q200II, o falta el tamaño de papel del paso 2 |
